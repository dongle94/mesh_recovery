...
class HRNetSMPLCam(nn.Module):
    def __init__(self, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        h36m_jregressor = np.load('./weights/smpl/J_regressor_h36m.npy')
        self.smpl = SMPL_layer(
            model_path='./weights/smpl/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl',
        ...
        # mean shape
        init_shape = np.load('./weights/smpl/h36m_mean_beta.npy')
