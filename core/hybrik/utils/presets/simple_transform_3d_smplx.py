...
from core.hybrik.utils.bbox import _box_to_center_scale, _center_scale_to_box
from core.hybrik.utils.transforms import (addDPG, affine_transform, flip_joints_3d, flip_thetas,
...
from core.hybrik.utils.pose_utils import get_intrinsic_metrix
from core.hybrik.models.layers.smplx.body_models import SMPLXLayer
# from hybrik.models.layers.smplx.joint_names import JOINT_NAMES


smplx_layer_neutral = SMPLXLayer(
    model_path='weights/smplx/SMPLX_NEUTRAL.npz',
    num_betas=10,
    use_pca=False,
    age='kid',
...
smplx_layer_male = SMPLXLayer(
    model_path='weights/smplx/SMPLX_MALE.npz',
    num_betas=10,
    use_pca=False,
    age='kid',
    kid_template_path='weights/smplx_kid_template.npy',
