...
from core.vibe.models.spin import Regressor, hmr
...
class VIBE(nn.Module):
    def __init__(
        ...
        bidirectional=False,
        use_residual=True,
        pretrained='weights/vibe/spin_model_checkpoint.pth.tar',
        smpl_mean_params='weights/vibe/smpl_mean_params.npz',
    ):
